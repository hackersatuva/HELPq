(function(){CONSTANTS = {
   ...
   *
   */
   Q_NAME: "HooHacks Mentor Queue",
   SPLASH_MESSAGE: "Hoo has a question?",

   // Path to image asset for desktop notifications
   NOTIFICATION_ICON: "/assets/images/hoohacks_favicon.png",
   ...
   TICKET_PANEL_TOPIC_PLACEHOLDER: "describe the problem and platform",

   TICKET_PANEL_LOCATION: "you can find me at",
   TICKET_PANEL_LOCATION_PLACEHOLDER: "building and room number",

   TICKET_PANEL_CONTACT: "You can contact me through",
   TICKET_PANEL_CONTACT_PLACEHOLDER: "cell phone #, email, etc.",

   TICKET_PANEL_HELP: "Help me!",
   TICKET_PANEL_CANCEL: "Nevermind!",

   TICKET_PANEL_OPEN: "Your ticket is open.",
   TICKET_PANEL_OPEN_MESSAGE: "We'll let you know when your ticket has been claimed by a mentor!",

   TICKET_PANEL_CLAIMED: "Help is on the way!",
